...
class Cards extends React.Component {
  ...
  getPosts = () => {
    axios
      .get("https://free-source-api.herokuapp.com/posts/")
      .then((response) => {
            ...
            >
              <CardBody>
                ...
                <Linkify target="_blank">
                  <CardText>{post.body || <Skeleton />}</CardText>
                </Linkify>

                {post.resource && (
                  <a
                    href={post.resource || <Skeleton />}
                    target="_blank"
